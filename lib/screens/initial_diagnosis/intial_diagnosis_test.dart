...
class _DiagnosisTestState extends State<DiagnosisTest> {
  ...
  List<Map<String, dynamic>> apiMap = testSymptoms;
      ...
      child: Scaffold(
        ...
        appBar: PreferredSize(
          ...
          child: AppBar(
            ...
            backgroundColor: ColorsConsts.primaryColor,
            // toolbarHeight: 65.0,
            title: Text("Symptom Specification"),
                      ...
                      TextButton(
                        ...
                        onPressed: (){
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                            content: Text(getAllNames().toString()+"\n"+"Age:${widget.birthYear.toString()}\n"+"Gender:${widget.gender}"),
                          ));
                          },
                      ...
                      TextButton(
                        ...
                        onPressed: (){
                          if(selectedValues.isNotEmpty) {
                            ...
                            {
                              ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                                content: Text("Please Select your Symptoms and try again",style: TextStyle(
                                  color: Colors.red,
                                  fontWeight: FontWeight.bold
                                ),),
                              ));
